// components/admin/ProdukHukumForm.tsx
...
import {
  createProdukHukumAction,
} from '@/app/admin/produk-hukum/actions';
...
export default function ProdukHukumForm() {
  const formRef =
      ...
      <div className="flex items-start gap-3 border-b border-slate-100 pb-5">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-relaxed text-slate-500">
            Unggah peraturan, keputusan,
            atau dokumen hukum Pemerintah
            Desa Keji dalam format PDF.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <div className="md:col-span-2">
          ...
          <input
            ...
            maxLength={300}
            disabled={isPending}
            placeholder="Contoh: Peraturan Desa Keji tentang RKP Desa Tahun 2026"
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            maxLength={5000}
            disabled={isPending}
            placeholder="Tuliskan ringkasan isi produk hukum."
