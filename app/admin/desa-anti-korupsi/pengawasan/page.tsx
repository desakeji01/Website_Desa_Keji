...
import {
  hapusDokumenPengawasanAction,
  hapusIndikatorPengawasanAction,
  tambahDokumenPengawasanAction,
  tambahIndikatorPengawasanAction,
  toggleDokumenPengawasanAction,
  toggleIndikatorPengawasanAction,
  ubahDokumenPengawasanAction,
  ubahIndikatorPengawasanAction,
} from '@/app/admin/desa-anti-korupsi/pengawasan/actions';
...
export default async function AdminPengawasanPage({
  searchParams,
}: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-7">
      ...
      >
        <SectionHeader
          eyebrow="Indikator II"
          title="Tambah Indikator Pengawasan"
          description="Tambahkan kategori indikator Pengawasan."
          icon={ClipboardCheck}
        />
      ...
      >
        ...
        0 ? (
          <EmptyState
            ...
            description="Jalankan SQL seed atau tambahkan indikator melalui formulir."
            icon={ClipboardCheck}
          />
        ) : (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 border-t border-slate-200 bg-white p-4">
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl bg-amber-100 px-3 text-xs font-extrabold text-amber-700"
                        >
                          <Power size={15} />
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl bg-red-100 px-3 text-xs font-extrabold text-red-700"
                        >
                          <Trash2 size={15} />
                          Hapus
                        </button>
                    ...
                    <details className="border-t border-slate-200 bg-white">
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-slate-800 px-5 text-sm font-extrabold text-white"
                        >
                          <Save size={16} />
                          Simpan Perubahan
                        </button>
      ...
      >
        <SectionHeader
          ...
          title="Tambah Dokumen Pengawasan"
          description="Masukkan link Google Drive untuk setiap bukti dukung."
          icon={FilePlus2}
        />
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              name="judul"
              label="Judul Dokumen"
              placeholder="Contoh: Undangan Kegiatan Pengawasan"
            />
          </div>
          ...
          <div className="flex items-end justify-end">
            <button
              ...
              className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-6 text-sm font-extrabold text-white disabled:cursor-not-allowed disabled:bg-slate-300 sm:w-auto"
            >
              <FilePlus2 size={17} />
              Tambah Dokumen
            </button>
                  ...
                  >
                    <div className="p-5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-4 inline-flex min-h-10 items-center gap-2 rounded-xl bg-emerald-700 px-4 text-xs font-extrabold text-white"
                      >
                        <ExternalLink
                          size={15}
                        />
  ...
  return (
    <div>
      ...
      <select
        ...
        required
        defaultValue={value}
        className="h-12 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm font-semibold text-slate-800 outline-none"
      >
...
function IndikatorSelect({
  ...
  idPrefix: string;
  indikator: AntiKorupsiIndikator[];
  value?: string;
}) {
  const id =
