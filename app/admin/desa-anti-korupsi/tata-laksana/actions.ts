// app/admin/desa-anti-korupsi/tata-laksana/actions.ts
...
function buildAdminUrl(
  ...
  return `/admin/desa-anti-korupsi/tata-laksana?${params.toString()}#${section}`;
}

function revalidateTataLaksana() {
  revalidatePath(
...
async function cekIndikatorTataLaksana(
  id: string
): Promise<{
  valid: boolean;
  message?: string;
  ...
  if (!data) {
    return {
      valid: false,
      message:
        'Indikator Tata Laksana tidak ditemukan.',
    };
  }
...
async function cekDokumenTataLaksana(
  id: string
): Promise<{
  valid: boolean;
  message?: string;
  ...
  if (!data) {
    return {
      valid: false,
      message:
        'Dokumen Tata Laksana tidak ditemukan.',
    };
  }

  return cekIndikatorTataLaksana(
    String(data.indikator_id)
  );
}

/* =========================================================
   INDIKATOR TATA LAKSANA
========================================================= */
...
export async function tambahIndikatorTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal menambahkan indikator Tata Laksana:',
      {
        message: error.message,
        code: error.code,
  ...
  revalidateTataLaksana();

  redirect(
    buildAdminUrl(
      'success',
      'Indikator Tata Laksana berhasil ditambahkan.'
    )
  );
}

export async function ubahIndikatorTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal memperbarui indikator Tata Laksana:',
      {
        message: error.message,
        code: error.code,
        details: error.details,
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Indikator Tata Laksana berhasil diperbarui.'
    )
  );
}

export async function toggleIndikatorTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function hapusIndikatorTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Indikator Tata Laksana berhasil dihapus.'
    )
  );
}
...
export async function tambahDokumenTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal menambahkan dokumen Tata Laksana:',
      {
        message: error.message,
        code: error.code,
        details: error.details,
...
export async function ubahDokumenTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function toggleDokumenTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function hapusDokumenTataLaksanaAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Dokumen Tata Laksana berhasil dihapus.',
      'daftar-dokumen'
    )
  );
}