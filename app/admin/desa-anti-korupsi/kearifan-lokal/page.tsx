// app/admin/desa-anti-korupsi/kearifan-lokal/page.tsx
...
import {
  hapusDokumenKearifanLokalAction,
  hapusIndikatorKearifanLokalAction,
  tambahDokumenKearifanLokalAction,
  tambahIndikatorKearifanLokalAction,
  toggleDokumenKearifanLokalAction,
  toggleIndikatorKearifanLokalAction,
  ubahDokumenKearifanLokalAction,
  ubahIndikatorKearifanLokalAction,
} from '@/app/admin/desa-anti-korupsi/kearifan-lokal/actions';
...
export default async function AdminKearifanLokalPage({
  searchParams,
}: PageProps) {
  const [
    params,
  ...
  if (indikatorResult.error) {
    console.error(
      'Gagal mengambil indikator Kearifan Lokal:',
      {
        message:
  ...
  if (indikatorIds.length > 0) {
    ...
    if (dokumenResult.error) {
      console.error(
        'Gagal mengambil dokumen Kearifan Lokal:',
        {
          message:
            dokumenResult.error
              .message,
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-7">
      ...
      >
        <SectionHeader
          eyebrow="Indikator V"
          title="Tambah Indikator Kearifan Lokal"
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              placeholder="Masukkan judul indikator Kearifan Lokal"
            />
          </div>
      ...
      >
        <SectionHeader
          ...
          title="Tambah Dokumen Kearifan Lokal"
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              name="judul"
              label="Judul Dokumen"
              placeholder="Contoh: Dokumentasi Kesenian dan Adat Istiadat"
            />
          </div>
