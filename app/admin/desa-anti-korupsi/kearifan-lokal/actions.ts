// app/admin/desa-anti-korupsi/kearifan-lokal/actions.ts
...
function buildAdminUrl(
  ...
  return `/admin/desa-anti-korupsi/kearifan-lokal?${params.toString()}#${section}`;
}

function revalidateKearifanLokal() {
  revalidatePath(
...
async function cekIndikatorKearifanLokal(
  id: string
): Promise<{
  valid: boolean;
  message?: string;
  ...
  if (!data) {
    return {
      valid: false,
      message:
        'Indikator Kearifan Lokal tidak ditemukan.',
    };
  }
...
async function cekDokumenKearifanLokal(
  id: string
): Promise<{
  valid: boolean;
  message?: string;
  ...
  if (!data) {
    return {
      valid: false,
      message:
        'Dokumen Kearifan Lokal tidak ditemukan.',
    };
  }

  return cekIndikatorKearifanLokal(
...
export async function tambahIndikatorKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal menambahkan indikator Kearifan Lokal:',
      {
        message: error.message,
        code: error.code,
  ...
  revalidateKearifanLokal();

  redirect(
    buildAdminUrl(
      'success',
      'Indikator Kearifan Lokal berhasil ditambahkan.'
    )
  );
}

export async function ubahIndikatorKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  const indikatorCheck =
    await cekIndikatorKearifanLokal(
      id
    );
  ...
  if (error) {
    console.error(
      'Gagal memperbarui indikator Kearifan Lokal:',
      {
        message: error.message,
        code: error.code,
        details: error.details,
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Indikator Kearifan Lokal berhasil diperbarui.'
    )
  );
}

export async function toggleIndikatorKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function hapusIndikatorKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Indikator Kearifan Lokal berhasil dihapus.'
    )
  );
}

/* =========================================================
   DOKUMEN KEARIFAN LOKAL
========================================================= */
...
export async function tambahDokumenKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal menambahkan dokumen Kearifan Lokal:',
      {
        message: error.message,
        code: error.code,
        details: error.details,
...
export async function ubahDokumenKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function toggleDokumenKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function hapusDokumenKearifanLokalAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Dokumen Kearifan Lokal berhasil dihapus.',
      'daftar-dokumen'
    )
  );
}