// app/admin/desa-anti-korupsi/pelayanan-publik/page.tsx
...
import {
  hapusDokumenPelayananPublikAction,
  hapusIndikatorPelayananPublikAction,
  tambahDokumenPelayananPublikAction,
  tambahIndikatorPelayananPublikAction,
  toggleDokumenPelayananPublikAction,
  toggleIndikatorPelayananPublikAction,
  ubahDokumenPelayananPublikAction,
  ubahIndikatorPelayananPublikAction,
} from '@/app/admin/desa-anti-korupsi/pelayanan-publik/actions';
...
export default async function AdminPelayananPublikPage({
  searchParams,
}: PageProps) {
  const [
    params,
  ...
  if (indikatorResult.error) {
    console.error(
      'Gagal mengambil indikator Kualitas Pelayanan Publik:',
  ...
  if (
    ...
    if (dokumenResult.error) {
      console.error(
        'Gagal mengambil dokumen Kualitas Pelayanan Publik:',
        dokumenResult.error
      );
    }
    ...
    <div className="mx-auto max-w-[1500px] space-y-7">
      ...
      <section className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          value={5}
          description="III.1 sampai III.5"
          icon={BadgeCheck}
        />
      </section>
      ...
      >
        <SectionHeader
          eyebrow="Indikator III"
          title="Tambah Indikator Pelayanan Publik"
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              placeholder="Masukkan judul indikator pelayanan publik"
            />
          </div>
      ...
      >
        <SectionHeader
          ...
          title="Tambah Dokumen Pelayanan Publik"
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              name="judul"
              label="Judul Dokumen"
              placeholder="Contoh: Prosedur Baku Pengaduan"
            />
          </div>
      ...
      >
        <SectionHeader
          ...
          title="Dokumen Pelayanan Publik"
