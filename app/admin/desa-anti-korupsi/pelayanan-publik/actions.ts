// app/admin/desa-anti-korupsi/pelayanan-publik/actions.ts
...
const SUB_SLUG = 'pelayanan-publik';
...
function buildAdminUrl(
  ...
  return `/admin/desa-anti-korupsi/pelayanan-publik?${params.toString()}#${section}`;
}

function revalidatePelayananPublik() {
  revalidatePath(
...
async function cekIndikatorPelayananPublik(
  id: string
): Promise<{
  valid: boolean;
  message?: string;
  ...
  if (!data) {
    return {
      valid: false,
      message:
        'Indikator Kualitas Pelayanan Publik tidak ditemukan.',
    };
  }
...
async function cekDokumenPelayananPublik(
  id: string
): Promise<{
  valid: boolean;
  message?: string;
  ...
  if (!data) {
    return {
      valid: false,
      message:
        'Dokumen Kualitas Pelayanan Publik tidak ditemukan.',
    };
  }

  return cekIndikatorPelayananPublik(
    String(data.indikator_id)
  );
}
...
export async function tambahIndikatorPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal menambahkan indikator Kualitas Pelayanan Publik:',
      {
        message: error.message,
        code: error.code,
  ...
  revalidatePelayananPublik();

  redirect(
    buildAdminUrl(
      'success',
      'Indikator Kualitas Pelayanan Publik berhasil ditambahkan.'
    )
  );
}

export async function ubahIndikatorPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  const indikatorCheck =
    await cekIndikatorPelayananPublik(
      id
    );

  if (!indikatorCheck.valid) {
    redirect(
      buildAdminUrl(
        'error',
  ...
  if (error) {
    console.error(
      'Gagal memperbarui indikator Kualitas Pelayanan Publik:',
      {
        message: error.message,
        code: error.code,
        details: error.details,
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Indikator Kualitas Pelayanan Publik berhasil diperbarui.'
    )
  );
}

export async function toggleIndikatorPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function hapusIndikatorPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Indikator Kualitas Pelayanan Publik berhasil dihapus.'
    )
  );
}
...
export async function tambahDokumenPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  if (error) {
    console.error(
      'Gagal menambahkan dokumen Kualitas Pelayanan Publik:',
      {
        message: error.message,
        code: error.code,
        details: error.details,
...
export async function ubahDokumenPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  const dokumenCheck =
    await cekDokumenPelayananPublik(
      id
    );
...
export async function toggleDokumenPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
...
export async function hapusDokumenPelayananPublikAction(
  formData: FormData
) {
  await requireAdmin();
  ...
  redirect(
    buildAdminUrl(
      'success',
      'Dokumen Kualitas Pelayanan Publik berhasil dihapus.',
      'daftar-dokumen'
    )
  );
}