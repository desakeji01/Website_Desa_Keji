// app/admin/desa-anti-korupsi/partisipasi-masyarakat/page.tsx
...
import {
  hapusDokumenPartisipasiAction,
  hapusIndikatorPartisipasiAction,
  tambahDokumenPartisipasiAction,
  tambahIndikatorPartisipasiAction,
  toggleDokumenPartisipasiAction,
  toggleIndikatorPartisipasiAction,
  ubahDokumenPartisipasiAction,
  ubahIndikatorPartisipasiAction,
} from '@/app/admin/desa-anti-korupsi/partisipasi-masyarakat/actions';
...
export default async function AdminPartisipasiMasyarakatPage({
  searchParams,
}: PageProps) {
  const [
    params,
  ...
  if (
    ...
    console.error(
      'Gagal mengambil indikator Partisipasi Masyarakat:',
      {
        message:
          indikatorResult.error
            .message,
  ...
  if (
    ...
    if (
      ...
      console.error(
        'Gagal mengambil dokumen Partisipasi Masyarakat:',
        {
          message:
            dokumenResult.error
              .message,
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-7">
      ...
      >
        <SectionHeader
          eyebrow="Indikator IV"
          title="Tambah Indikator Partisipasi Masyarakat"
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              placeholder="Masukkan judul indikator partisipasi masyarakat"
            />
          </div>
      ...
      >
        <SectionHeader
          ...
          title="Tambah Dokumen Partisipasi Masyarakat"
          description="Masukkan tautan Google Drive tanpa mengunggah file ke website."
          icon={FilePlus2}
        />
        ...
        <div className="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <TextInput
              ...
              name="judul"
              label="Judul Dokumen"
              placeholder="Contoh: Dokumentasi Musyawarah Dusun"
            />
          </div>
      ...
      >
        <SectionHeader
          ...
          title="Dokumen Partisipasi Masyarakat"
