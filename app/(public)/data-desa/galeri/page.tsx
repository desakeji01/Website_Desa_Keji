...
export const metadata: Metadata = {
  title:
    'Galeri Desa Keji | SIJI',

  description:
    'Dokumentasi kegiatan pemerintahan, masyarakat, budaya, pembangunan, dan potensi Desa Keji.',
};
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-medium leading-7 text-emerald-800">
                    ...
                    untuk melihat kumpulan
                    dokumentasi secara lebih
                    lengkap. Album dikelola
                    dan dipublikasikan melalui
