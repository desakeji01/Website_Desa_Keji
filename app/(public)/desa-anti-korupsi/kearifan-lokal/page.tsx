...
export const metadata: Metadata = {
  title:
    'Kearifan Lokal Desa Anti Korupsi | SIJI',

  description:
    'Dokumen dan bukti dukung penguatan kearifan lokal Desa Anti Korupsi Desa Keji.',
};
          ...
          <div className="mt-7 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-3xl text-sm font-medium leading-7 text-emerald-50/85 sm:text-base">
                Dokumen budaya lokal,
                adat istiadat, hukum
                adat, peraturan,
                penetapan tokoh
                masyarakat, testimoni,
                publikasi, dan aktivitas
                tokoh Desa Keji.
              </p>
            </div>
